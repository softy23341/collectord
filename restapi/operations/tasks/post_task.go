...
type PostTaskHandlerFunc func(PostTaskParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostTaskHandlerFunc) Handle(params PostTaskParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// PostTaskHandler interface for that can handle valid post task params
type PostTaskHandler interface {
	Handle(PostTaskParams, interface{}) middleware.Responder
}
...
/*PostTask swagger:route POST /task Tasks postTask
