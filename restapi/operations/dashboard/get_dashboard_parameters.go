...
func (o *GetDashboardParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	qObjectsCntPerCollection, qhkObjectsCntPerCollection, _ := qs.GetOK("objectsCntPerCollection")
	if err := o.bindObjectsCntPerCollection(qObjectsCntPerCollection, qhkObjectsCntPerCollection, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetDashboardParams) bindObjectsCntPerCollection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	...
	if err != nil {
		return errors.InvalidType("objectsCntPerCollection", "query", "int16", raw)
	}
	o.ObjectsCntPerCollection = &value

	return nil
}

func (o *GetDashboardParams) bindRootID(rawData []string, hasKey bool, formats strfmt.Registry) error {
