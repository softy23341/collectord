...
type GetDashboardHandlerFunc func(GetDashboardParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetDashboardHandlerFunc) Handle(params GetDashboardParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetDashboardHandler interface for that can handle valid get dashboard params
type GetDashboardHandler interface {
	Handle(GetDashboardParams, interface{}) middleware.Responder
}
