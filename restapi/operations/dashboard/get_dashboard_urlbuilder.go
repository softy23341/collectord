...
func (o *GetDashboardURL) Build() (*url.URL, error) {
	...
	var objectsCntPerCollection string
	if o.ObjectsCntPerCollection != nil {
		objectsCntPerCollection = swag.FormatInt16(*o.ObjectsCntPerCollection)
	}
	if objectsCntPerCollection != "" {
		qs.Set("objectsCntPerCollection", objectsCntPerCollection)
	}
