...
type PostChatHandlerFunc func(PostChatParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostChatHandlerFunc) Handle(params PostChatParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// PostChatHandler interface for that can handle valid post chat params
type PostChatHandler interface {
	Handle(PostChatParams, interface{}) middleware.Responder
}
...
/*PostChat swagger:route POST /chat Chat postChat
